...
Như đã thảo luận trong Phần 2.3.2, đối với quá trình phân cực, điện áp đầu cuối hoàn thành quá trình nhất thời theo cấp số nhân gần đúng khi dòng điện thay đổi đột ngột. Theo định luật Kirchhoff, đối với mô hình RC bậc nhất, định luật biến thiên của điện áp đầu cực có thể được xác định theo công thức sau:
